...
if(!isset($_SESSION['is_login'])){
  ...
  if(isset($_REQUEST['rEmail'])){
    ...
    $sql = "SELECT r_email, r_password FROM user_tb WHERE r_email='".$rEmail."' AND r_password='".$rPassword."' limit 1";
...
<body style="background-color:powderblue;">
  ...
  <div class="container-fluid mb-5">
    <div class="row justify-content-center custom-margin" >
      <div class="col-sm-6 col-md-4" style = "background-color: #FFF8DC" >
        <form action="" class="shadow-lg p-4" method="POST">
         ...
         <em style="font-size:10px;"><a href="../Registration.php">create an account</a></em>
